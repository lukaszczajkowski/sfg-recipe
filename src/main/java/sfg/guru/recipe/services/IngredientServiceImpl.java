...
public class IngredientServiceImpl implements IngredientService {
    ...
    public IngredientServiceImpl(RecipeService recipeService,
                                 IngredientToIngredientCommand ingredientToIngredientCommand, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository, IngredientCommandToIngredient ingredientCommandToIngredient) {
    ...
    public IngredientCommand saveIngredientCommand(IngredientCommand command) {
        log.info("Saving ingredient command " + command);
